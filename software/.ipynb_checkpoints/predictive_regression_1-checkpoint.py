...
# Generate samples
lin_samples1 = [sample_line(*lin_mles1[i], np.linspace(0,max(areas1[i]),1000), size=1000) for i in range(len(lin_mles1))]
lin_samples2 = [sample_line(*lin_mles2[i], np.linspace(0,max(areas2[i]),1000), size=1000) for i in range(len(lin_mles2))]
exp_samples1 = [sample_exp(*exp_mles1[i], np.linspace(0,max(areas1[i]),1000), size=1000) for i in range(len(exp_mles1))]
exp_samples2 = [sample_exp(*exp_mles2[i], np.linspace(0,max(areas2[i]),1000), size=1000) for i in range(len(exp_mles2))]
...
for i in range(len(lin_samples1)):
    ...
    samples_x = np.linspace(0,max(areas1[i]),1000),
...
for i in range(len(lin_samples1)):
    ...
    samples_x = np.linspace(0,max(areas1[i]),1000)+200,
